...
namespace Store.Persistence.Migrations
{
    ...
    [Migration("20250704064020_Initialcreate3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Store.Domain.Entities.HomePages.HomePageImage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasCheckConstraint("CK_HomePageImages_ImageLocation_Enum_Constraint", "[ImageLocation] IN(0, 1, 2, 4, 5, 6)");
                });
            ...
            modelBuilder.Entity("Store.Domain.Entities.Orders.Order", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Order_OrderState_Enum_Constraint", "[OrderState] IN(0, 1, 2)");
                });
            ...
            modelBuilder.Entity("Store.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2025, 7, 4, 10, 10, 19, 912, DateTimeKind.Local).AddTicks(227),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2025, 7, 4, 10, 10, 19, 913, DateTimeKind.Local).AddTicks(4281),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2025, 7, 4, 10, 10, 19, 913, DateTimeKind.Local).AddTicks(4351),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
